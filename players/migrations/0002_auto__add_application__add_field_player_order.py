...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('players_application', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('title', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('main_text', self.gf('django.db.models.fields.TextField')(default='', blank=True)),
            ('roster_image_main', self.gf('feincms.module.medialibrary.fields.MediaFileForeignKey')(blank=True, related_name='as_roster_image_main', null=True, to=orm['medialibrary.MediaFile'])),
        ))
        db.send_create_signal('players', ['Application'])

        # Adding field 'Player.order'
        db.add_column('players_player', 'order',
    ...
    def backwards(self, orm):
        ...
        db.delete_table('players_application')

        # Deleting field 'Player.order'
        db.delete_column('players_player', 'order')
