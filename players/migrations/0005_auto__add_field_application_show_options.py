...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Application.show_options'
        db.add_column('players_application', 'show_options',
                      self.gf('django.db.models.fields.CharField')(default='IN', max_length=2),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Application.show_options'
        db.delete_column('players_application', 'show_options')
    ...
    models = {
        ...
        'players.application': {
            ...
            'show_options': ('django.db.models.fields.CharField', [], {'default': "'IN'", 'max_length': '2'}),
